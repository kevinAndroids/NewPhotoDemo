...
import cn.lemon.multi.ui.MultiClickLinstener;
...
/*                Intent intent = new Intent(getContext(), ViewImageActivity.class);
                ...
                if (customCallBack != null) {
                    customCallBack.onOneClick(position + "", mData);
                    Log.e("kankan", "" + position);
                } Log.e("kankan", "nullll" );
            }
        });
    ...
    public void setOnOneClickListener(CustomCallBack listener){
